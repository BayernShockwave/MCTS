...
if len(earliest_conflicts) == 0:
    ...
    initial_conflicts = [{
        'course_id_1': ROOT_CONFLICT['course_id_1'],
        'course_id_2': ROOT_CONFLICT['course_id_2'],
        'course_seq_1': ROOT_CONFLICT['course_seq_1'],
        'course_seq_2': ROOT_CONFLICT['course_seq_2'],
        'start_node': ROOT_CONFLICT['start_node'],
        'end_node': ROOT_CONFLICT['end_node'],
        'place': ROOT_CONFLICT['place'],
        'detail': ROOT_CONFLICT['detail'],
        'start_secs': ROOT_CONFLICT['start_secs'],
        'start_time': ROOT_CONFLICT['start_time'],
        'time_gap': ROOT_CONFLICT['time_gap'],
        'conflict_type': ROOT_CONFLICT['conflict_type']
    }]
